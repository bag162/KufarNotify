...
Regex regEx = new Regex(@"<section><a class=.styles_wrapper__[0-9a-zA-Z]+.+href..(https...re.kufar.by.vi.minsk.snyat.kvartiru-dolgosrochno.[0-9]+).rank.[0-9]+.amp.searchId.[0-9a-z]+.", RegexOptions.Compiled);
